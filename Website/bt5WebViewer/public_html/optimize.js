//from https://github.com/dfm/optimize.js
...
window.randomNormal = function () {
    ...
    'use strict';
    var f, u, v, s = 0.0,
        tmp = window._randNorm;
    if (window._randNorm !== null && typeof (window._randNorm) !== "undefined") {
        tmp = window._randNorm;
        window._randNorm = null;
        return tmp;
    }
...
window.optimize = (function () {
    ...
    vector.range = function (a, b, c) {
        ...
        for (x = xmin, i = 0; x < xmax; x += dx, i += 1) {
            rng[i] = x;
        }
        return rng;
    };
    ...
    optimize.fmin = function (func, x0, opts) {
        ...
        var N, rho, chi, psi, sigma, sim, fsim, i, j, iterations, nonzdelt, zdelt, x, fval, xtol, ftol, maxiter, y, inds, xbar, xr, fxr, doshrink = false,
            xe, fxe, xc, fxc;
        ...
        maxiter = _q(opts.maxiter) ? opts.maxiter : 400 * N;
    ...
    optimize.newton = function (fn, x0, opts) {
        ...
        var N, ftol, maxiter, fprime, ep, alpha, J, JT, JTJ, diagJTJ, JTfx0, dx, fx, fx0, df, chi0, chi20, JTfx, i, x_best, chi_best, chi2_best, n, x_try, chi_try, chi2_try, dchi2;
    ...
    optimize.test = function () {
        var x, synth, data, chi, chi2, p0 = [10.5, 6.0],
            truth = [5.3, 3.0],
            p_newton, p_fmin;
        ...
        synth = function (x, noise) {
            ...
            for (t = -10; t <= 10; t += 1) {
                result.push(sky + Math.exp(-0.5 * t * t / v2) * norm + noise * window.randomNormal());
            }
            return result;
        };
